...
class NormalNavigationCell(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0): NavigationBase(context, attrs, defStyleAttr) {

    init {
        val inflater = context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        inflater.inflate(R.layout.normal_icon, this, true)
    }
